...
import de.codingair.tradesystem.spigot.trade.gui_v2.layout.types.utils.AnvilGUIIcon;
import de.codingair.tradesystem.spigot.trade.gui_v2.layout.types.utils.SignGUIIcon;
import de.codingair.tradesystem.spigot.trade.gui_v2.layout.types.utils.SimpleAnvilGUIIcon;
import de.codingair.tradesystem.spigot.trade.gui_v2.layout.types.utils.SimpleSignGUIIcon;
            ...
            case SIGN:
                this.icon = new SimpleSignGUIIcon<G>(itemStack) {
                    ...
                    public @NotNull ItemStack getEditorIcon(@NotNull TradeLayout layout, @NotNull Player player) {
                        return InputIcon.this.getEditorIcon(layout, player);
                    }
