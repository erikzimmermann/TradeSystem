...
public class TradeRequestResponseEvent extends TradeEvent {
     ...
     */
    public TradeRequestResponseEvent(@NotNull String sender, @NotNull UUID senderId, @Nullable Player sendingPlayer, @NotNull String receiver, @NotNull UUID receiverId, @Nullable Player receivingPlayer, boolean accepted) {
        this.sender = sender;
